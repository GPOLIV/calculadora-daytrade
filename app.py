...
with st.sidebar:
    ...
    stop_loss = st.number_input("🛑 Stop Loss (em pontos/pips)", min_value=0.1, value=50.0, help="Distância do preço até o stop. 10 pontos = 1 pip.")
...
st.write(f"⚖️ Risco/Retorno: `{risco_valor:.2f} / {simulacao['retorno_total']:.2f}`")
